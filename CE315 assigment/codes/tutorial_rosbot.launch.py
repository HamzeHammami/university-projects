...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('tutorial_pkg', default_value=[EnvironmentVariable('USER'),'_'], description='tutorial_pkg_node'),
             Node(package='tutorial_pkg', executable='tutorial_pkg_node', output='screen', name=[LaunchConfiguration('tutorial_pkg'), 'tutorial_pkg_node']),
